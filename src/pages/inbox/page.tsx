            ...
            <div className="h-175">
              ...
              <div className="w-55 flex flex-col">
                <button
                  ...
                  className={`flex font-medium py-3 rounded ${
                    activeMenu === "inbox"
                      ? "bg-[#E6EEFF] text-blue-500"
                      : "text-black hover:bg-blue-400 hover:text-white"
                  }`}
                >
                  <MdOutlineEmail className="h-6 w-15" />
                  Inbox
                </button>
                <button
                ...
                >
                  <IoPaperPlaneOutline className="h-5 w-15" />
                  Sent
                </button>
                <button
                ...
                >
                  <SlPencil className="h-5 w-15" />
                  Draft
                </button>
                <button
                  onClick={() => setActiveMenu("spam")}
                  className={`flex font-medium py-3 rounded ${
                    activeMenu === "spam"
                      ? "bg-[#E6EEFF] text-blue-500"
                      : "text-black hover:bg-blue-400 hover:text-white"
                ...
                >
                  <IoWarningOutline className="h-5 w-15" />
                  Spam
                </button>
                <button
                ...
                >
                  <LuMessageCircleWarning className="h-5 w-15" />
                  Important
                </button>
                <button
                ...
                >
                  <FaRegTrashAlt className="h-5 w-15" />
                  Bin
                </button>
              </div>
              ...
              <div className="flex flex-col w-60">
                ...
                <button className="flex font-medium py-3 rounded">
                  <IoSquareOutline className="h-5 w-15 text-[#2B7FFF]" />
                  Primary
                </button>

                <button className="flex font-medium py-3 rounded">
                  <IoSquareOutline className="h-5 w-15 text-[#F0B100]" />
                  Social
                </button>

                <button className="flex font-medium py-3 rounded">
                  <IoSquareOutline className="h-5 w-15 text-[#00C951]" />
                  Work
                </button>

                <button className="flex font-medium py-3 rounded">
                  <IoSquareOutline className="h-5 w-15 text-[#AD46FF]" />
                  Friends
                </button>
              </div>
            </div>
...
const InboxContent = () => {
  ...
  const emailsPerPage = 10; // Quantos e-mails serão exibidos por página
  ...
  return (
    <>
      <div className="flex flex-col bg-white justify-center h-170 w-300 rounded-2xl mb-2">
        {/* Lista de e-mails */}
        <div className="z-50">
          <div className="flex gap-190">
            <input
              ...
              type="text"
              placeholder="Search"
              className="bg-[#F0F0F4] rounded-3xl text-center mb-5 ml-5 h-9 border border-gray-300"
            />
          ...
          {currentEmails.length > 0 ? (
            currentEmails.map((email) => (
              <div key={email.id} className="bg-white p-2">
                <div className="grid grid-cols-6 items-center w-300">
                  ...
                  <span
                    className={`flex justify-center items-center h-10 w-20 text-sm rounded-full ${getCategoryColor(
                      email.category
                    )}`}
                  >
                    {email.category}
                  ...
                  <span className="flex justify-end text-sm text-gray-400 w-80">
                    {email.time_received}
                  </span>
                </div>
              </div>
      ...
      <div>
          ...
          <h1 className="ml-10 font-bold text-[#0000005c]"> Page {currentPage} of {totalPages}</h1>
...
const StarredContent = () => <div className="mt-7.5"></div>;

const SentContent = () => <div className="mt-7.5"></div>;

const DraftContent = () => <div className="mt-7.5"></div>;

const SpamContent = () => <div className="mt-7.5"></div>;

const ImportantContent = () => <div className="mt-7.5"></div>;

const BinContent = () => <div className="mt-7.5"></div>;
